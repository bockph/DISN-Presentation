...
As these methods are quite intuitiv in their usage they are very easy to encode. However, if such a representation is choosen a limited resolution and fixed mesh topology has to be assumed -- limiting the flexibility of an approach. These drawbacks, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzU0NjIzNTIsLTE0NTM5NzcwNTksMj
