...
$$ \text{F-score} =2* \frac{Precision*Recall}{Precision+Recall}$$ Here counts the higher the better, while a smaller threshold describes a bigger similarity.
...
##Sources
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjA3MjY3MjgsOTE0NjU1MTI0LC0xMT
