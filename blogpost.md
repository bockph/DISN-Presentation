...
While humans are quite good in recognizing objects and deriving their properties using intuition, for machines it is a rather complex, but as a core technology for a variety of fields, needed task to recover a 3D shape from a single view. Therefore, it has been an ongoing research field, which experienced in the last few years quite some progress particulary driven by deep learning. However, while most work already delivers quite decent results on recovering the overall shape, most of them lack the capability of
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjA1OTM5MTUsMjEyMzIxMTY5OCwtMzQ5OD
