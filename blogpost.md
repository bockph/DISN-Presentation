...
While humans are quite good in recognizing objects and deriving their properties using intuition, for machines it is a rather complex task to recover a 3D shape from a single view. Despite the complexity, it is needed as a core technology for a variety of fields and therefore, and has been an ongoing research field which experienced quite some progress in the last few years driven by DeepLearning approaches. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3Njk3OTg2NiwyMTIzMjExNjk4LC0zND
